...
[TestFixture]
public class SubsectorGeneratorTests
{
    private readonly SubsectorGenerator _classUnderTest = new();
    ...
    {
        var sectorCoordinates = new Coordinates(x1, y1);
        var hexCoordinates = new Coordinates(x2, y2);

        Coordinates result = _classUnderTest.GetCoordinates(sectorCoordinates, hexCoordinates);
