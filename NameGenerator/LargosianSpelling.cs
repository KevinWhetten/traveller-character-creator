...
public class SsitolusssSpelling
{
    public static string CheckSsitolusssSpelling(string name)
    {
    ...
    public static string ReplaceInvalidVowelPairs(string name)
    {
    ...
    public static string ReplaceTripleVowels(string name)
    {
        var vowelNum = 0;
    ...
    public static string ReplaceEndingY(string name)
    {
        string newName = name;
    ...
    public static string RemoveQuadSs(string name)
    {
        string newName = name.ToLower();
    ...
    public static string RemoveDoubleLetters(string name)
    {
        string newName = name.ToLower();
    ...
    public static string CheckMiddleSs(string name)
    {
        string newName = name;
    ...
    public static string CheckBeginningSs(string newName)
    {
    ...
    public static string CheckLastSs(string name)
    {
    ...
    public static string ReplaceEndingConsonants(string name)
    {
        string newName = name;
