...
import {WorldBuilderComponent} from "./sector-creator/world-builder/world-builder.component";
import { WorldBuilderSectorComponent } from './sector-creator/world-builder/world-builder-sector/world-builder-sector.component';
import { WorldBuilderSubsectorComponent } from './sector-creator/world-builder/world-builder-sector/world-builder-subsector/world-builder-subsector.component';
import { WorldBuilderHexComponent } from './sector-creator/world-builder/world-builder-sector/world-builder-subsector/world-builder-hex/world-builder-hex.component';
import { WorldBuilderPlanetComponent } from './sector-creator/world-builder/world-builder-sector/world-builder-subsector/world-builder-hex/world-builder-planet/world-builder-planet.component';
...
@NgModule({
  declarations: [
    ...
    WorldBuilderSectorComponent,
    WorldBuilderSubsectorComponent,
    WorldBuilderHexComponent,
    WorldBuilderPlanetComponent,
  ],
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path: 'sector-creator/world-builder', component: WorldBuilderComponent},
      {path: 'sector-creator/world-builder-sector/:id', component: WorldBuilderSectorComponent},
    ], {
