...
public class TectonicWorldTests
{
    ...
    [TestCase(1, 1, 2, 1, 2, 2, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 0, 10, 0)]
    [TestCase(1, 1, 2, 7, 2, 2, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 4, 2, 0)]
    [TestCase(1, 1, 2, 10, 2, 2, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 7, 2, 0)]
    [TestCase(1, 1, 2, 12, 2, 2, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 9, 2, 0)]
    ...
    [TestCase(1, 1, 2, 7, 2, 7, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 4, 2, 5)]
    [TestCase(1, 1, 2, 7, 2, 10, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 4, 2, 8)]
    [TestCase(1, 1, 2, 7, 2, 12, PlanetOrbit.Inner, 9, SpectralType.D, Luminosity.I, 5, PlanetChemistry.Water, 4, 2, 10)]
